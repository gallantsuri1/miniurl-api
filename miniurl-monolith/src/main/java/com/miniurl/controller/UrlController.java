...
public class UrlController {
    ...
    @Operation(
        ...
        description = "Retrieve details of a shortened URL by ID (only owner can access)"
    )
    @ApiResponses(value = {
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "URL not found",
            content = @Content(schema = @Schema(implementation = ApiResponse.class))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Unauthorized or not the URL owner",
            content = @Content(schema = @Schema(implementation = ApiResponse.class)))
    })
    public ResponseEntity<ApiResponse> getUrlById(
        ...
        return ResponseEntity.ok(ApiResponse.success("URL details retrieved successfully", response));
    }
